...
out = griddata( x, y, z, Xi,Yi, 'nearest' );     % interp: nearest, linear, spline, cubic
figure; surf( out );                           % rysunek             
figure; mesh( out ); pause                     % rysunek             

              
out = griddata( x, y, z, Xi,Yi, 'linear' );     
figure; surf( out );                                      
figure; mesh( out ); pause                       
