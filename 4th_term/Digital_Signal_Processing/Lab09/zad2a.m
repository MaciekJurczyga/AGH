...
%% wczytanie sygna³u wejœciowego
[dref,fs]=audioread('mowa8000.wav');

%% sygna³ z szumem bia³ym zamiast mowy
...
%mamy odpowiedŸ impulsow¹ i mamy œledziæ jej zmiany. mamy tylko
%zidentyfikowaæ kana³ xd i tam przestrajane s¹ w³aœnie te wagi tego filtra
